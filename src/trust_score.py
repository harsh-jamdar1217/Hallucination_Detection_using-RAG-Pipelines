...
REFUSAL_PHRASES = [
    "i don't know", "i do not know", "cannot be determined",
    "not mentioned in the context", "no information", "context does not"
]


def is_refusal(sentence):
